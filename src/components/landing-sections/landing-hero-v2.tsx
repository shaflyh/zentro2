...
export default function LandingHero({
  ...
  return (
    ...
    >
      ...
      <div className="page-element absolute w-74 h-24 left-0 top-0 flex items-center z-20 bg-[url('/logo-bg.svg')] bg-no-repeat bg-cover bg-left filter drop-shadow-[0_12px_24px_rgba(0,0,0,0.4)]">
        <div className="pl-10">
          <span className="text-black text-4xl font-bold font-['Satoshi'] tracking-[7px]">
            Zentro
          </span>
        </div>
      </div>
