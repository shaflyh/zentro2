...
export default function MobileLanding() {
  ...
  useEffect(() => {
    ...
    if (metaThemeColor) {
      ...
      metaThemeColor.setAttribute(
        "content",
        showWhiteFlash || landingComplete ? "#ffffff" : "#000000",
      );
    }
  ...
  useEffect(() => {
    ...
    // Fade out text
    tl.to(".intro-letter", { opacity: 0, duration: 0.3 });
  ...
  useEffect(() => {
    if (!landingComplete || !cardSectionRef.current || !whyZentroRef.current)
      return;
    ...
    const handleScroll = () => {
      ...
      const scrollProgress =
        -cardRect.top / (cardRect.height - window.innerHeight);
      ...
      const reverseProgress = Math.max(
        ...
        Math.min(
          1,
          (whyZentroRect.top - window.innerHeight * 0.3) /
      ...
      >
        ...
        <div className="absolute top-32 left-0 right-0 flex justify-center px-6 z-10">
          <div className="flex flex-col items-center text-center space-y-4">
            <span className="text-white text-4xl font-bold font-['Satoshi'] tracking-[7.2px]">
              Zentro
            </span>
            <div className="max-w-sm space-y-2">
              ...
              <p className="text-white/60 text-sm leading-relaxed">
                Zero-knowledge banking infrastructure for those who value
                discretion. Your transactions, truly private.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="absolute bottom-12 left-0 right-0 flex justify-center px-6 z-20">
          <GlassButton onClick={handleSwipeUp} className="px-8 py-4">
        ...
        <div className="mobile-content">
          ...
          <header className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md">
            <div className="flex items-center justify-between px-6 py-4">
              <span className="text-black text-2xl font-bold font-['Satoshi'] tracking-[7.2px]">
                Zentro
              </span>
          ...
          <section className="bg-white pt-24">
            ...
            <div className="max-w-md mx-auto text-center space-y-4 px-6 pt-8 pb-8">
              ...
              <p className="text-xl text-gray-700 leading-relaxed">
                You don't compromise when earning, so don't compromise when
                spending
              </p>
              ...
              <div className="space-y-4">
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Zero-knowledge proofs ensure your spending remains
                ...
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Member-owned infrastructure with no corporate oversight or
                      data tracking.
                    </p>
                  </div>
                </GlassButton>
                ...
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Deposit crypto instantly and spend as fiat anywhere, with
                      complete discretion.
                    </p>
                  </div>
                </GlassButton>
              ...
              <div className="space-y-4">
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Current members invite new applicants through our
                      verification process. Each invitation is carefully
                      reviewed to ensure alignment with Zentro's values of
                ...
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Your transactions remain private through zero-knowledge
                      proofs and encrypted protocols. We don't track, sell, or
                      share your financial data with anyone.
                    </p>
                  </div>
                </GlassButton>
                ...
                <GlassButton className="w-full p-6 text-left">
                  <div className="space-y-3">
                    ...
                    <p className="text-gray-600">
                      Membership requires an invitation from an existing member.
                      We carefully curate our community to maintain exclusivity
                      and shared values.
                    </p>
                  </div>
                </GlassButton>
          ...
          <section className="min-h-screen flex items-center justify-center px-6 bg-gray-50">
            <div className="max-w-md mx-auto text-center space-y-6">
              ...
              <p className="text-sm text-gray-600 leading-relaxed pt-4">
                Zentro Finance provides zero-knowledge financial infrastructure
                for those who value discretion.
              </p>
            </div>
          </section>
